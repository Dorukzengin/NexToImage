  ...
  const features = [
    {
      ...
      description: 'Sadece bir metin açıklaması ile profesyonel kalitede görüntüler oluşturun.',
      color: 'text-blue-500'
    },
    {
      icon: Image,
      title: 'Görüntüden Görüntü',
      description: 'Mevcut görüntülerinizi AI ile dönüştürün ve yeni stiller uygulayın.',
      color: 'text-purple-500'
    },
    {
      icon: Sparkles,
      title: 'Yüksek Kalite',
      description: 'Flux Pro AI teknolojisi ile 4K çözünürlüğe kadar görüntü üretimi.',
      color: 'text-emerald-500'
    }
  ];

  const stats = [
    { number: '1M+', label: 'Üretilen Görüntü' },
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              NexToImage, gelişmiş Flux Pro AI teknolojisi ile metinlerinizi ve görüntülerinizi 
              profesyonel kalitede sanat eserlerine dönüştürür. Hayal gücünüzü sınırsız hale getirin.
            </p>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-lg p-4 text-left">
                    ...
                    <p className="text-gray-800">"Gün batımında lavanta tarlası, dijital sanat"</p>
                  </div>
                  <div className="flex items-center space-x-2 text-sm text-gray-500">
                    <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                    <span>2 saniyede üretildi</span>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              NexToImage ile yaratıcılığınızın sınırlarını keşfedin
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              3 basit adımda profesyonel görüntüler oluşturun
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Açıklama Yazın</h3>
              <p className="text-gray-600">
                İstediğiniz görüntüyü detaylı bir şekilde tanımlayın veya mevcut bir görüntü yükleyin.
              </p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">AI İşleme</h3>
              <p className="text-gray-600">
                Gelişmiş Flux Pro AI teknolojimiz açıklamanızı analiz eder ve görüntü üretir.
              </p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">İndirin & Paylaşın</h3>
              <p className="text-gray-600">
                Yüksek kaliteli görüntünüzü indirin ve istediğiniz yerde kullanın.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 mb-8">
            2 ücretsiz kredi ile hemen başlayın. Kredi kartı gerekmez.
          </p>
          <button
            onClick={onGetStarted}
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 max-w-md">
                AI destekli görüntü üretimi ile yaratıcılığınızı sınırsız hale getirin. 
                Profesyonel kalitede sonuçlar, kullanıcı dostu arayüz.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 NexToImage. Tüm hakları saklıdır.</p>
          </div>
        </div>
      </footer>
    </div>
