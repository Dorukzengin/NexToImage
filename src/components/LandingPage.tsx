      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join thousands of creators and get <strong>2 free image credits</strong> instantly. No credit card required.
          </p>
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 mb-8 max-w-2xl mx-auto">
            <div className="flex items-center justify-center space-x-4 mb-4">
              <div className="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center">
                <span className="text-white font-bold text-xl">🎁</span>
              </div>
              <div className="text-left">
                <h3 className="text-lg font-semibold text-gray-900">Welcome Bonus</h3>
                <p className="text-gray-600">2 Free Image Credits</p>
              </div>
            </div>
            <p className="text-sm text-gray-600">
              Perfect for trying out our AI image generation technology
            </p>
          </div>
          <button
            onClick={onGetStarted}
